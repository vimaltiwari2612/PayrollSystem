...
public class AddEmployee extends JFrame implements ActionListener,ItemListener
{
...
public AddEmployee(MainMenu mainMenu)
{
...
this.setIconImage(new ImageIcon(this.getClass().getResource(GlobalResources.ADD_MODULE)).getImage());
...
add=new JButton("Add",new ImageIcon(this.getClass().getResource(GlobalResources.ADD_BUTTON)));
...
address.setBounds(130,50,150,30);
...
allowanceLabel.setBounds(510,218,200,20);
deductionLabel.setBounds(800,218,100,20);
...
netSalaryButton.setBounds(370,560,120,30);
...
{
AddEmployee m=AddEmployee.this;
...
if(employeeModel.isEmpty(ID))
{
ID.requestFocus();
JOptionPane.showMessageDialog(this,"ID field is empty","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
if(employeeModel.checkInt(ID)==false)
{
ID.requestFocus();
JOptionPane.showMessageDialog(this,"ID Field- only Numbers Are allowed","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
...
if(employeeModel.checkInt(totalSalary)==false)
{
totalSalary.requestFocus();
JOptionPane.showMessageDialog(this,"Salary Field -only Numbers are allowed","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}

if(employeeModel.isEmpty(totalSalary))
{
totalSalary.requestFocus();
JOptionPane.showMessageDialog(this,"Salary Field can't be Empty","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}


if(employeeModel.checkInt(lifeInsurance) && employeeModel.checkInt(generalProvidentFund) && employeeModel.checkInt(incomeTax) && employeeModel.checkInt(otherTax) )
{
deductionLabel.setForeground(Color.black);
}

if(employeeModel.checkInt(dearness) && employeeModel.checkInt(cityCompensatory) &&employeeModel.checkInt(fixedMedical) && employeeModel.checkInt(fixedMedical) &&employeeModel.checkInt(vehicle) && employeeModel.checkInt(daily) && employeeModel.checkInt(otherAllowance) && employeeModel.checkInt(overTime))
{
allowanceLabel.setForeground(Color.black);
}

if(employeeModel.checkInt(dearness)==false || employeeModel.checkInt(cityCompensatory)==false || employeeModel.checkInt(fixedMedical)==false || employeeModel.checkInt(fixedMedical)==false || employeeModel.checkInt(vehicle)==false || employeeModel.checkInt(daily)==false || employeeModel.checkInt(otherAllowance)==false || employeeModel.checkInt(overTime)==false )
{
allowanceLabel.setForeground(Color.red);
JOptionPane.showMessageDialog(this,"Allowances Fields -only Numbers are allowed","Notification",JOptionPane.ERROR_MESSAGE);
return false;
}

if(employeeModel.checkInt(lifeInsurance)==false || employeeModel.checkInt(generalProvidentFund)==false || employeeModel.checkInt(incomeTax)==false || employeeModel.checkInt(otherTax)==false) {
deductionLabel.setForeground(Color.red);
JOptionPane.showMessageDialog(this,"Deduction Fields -only Numbers are allowed","Notification",JOptionPane.ERROR_MESSAGE);
return false;
}

if(String.valueOf(designation.getItemAt(designation.getSelectedIndex())).equals("other.."))
{
if(employeeModel.isEmpty(otherPosition))
{
otherPosition.requestFocus();
JOptionPane.showMessageDialog(this,"Designation Field is Empty","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
if(employeeModel.checkChar(otherPosition)==false)
{
otherPosition.requestFocus();
JOptionPane.showMessageDialog(this,"Designation Field -only Characters are allowed","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
}
if(employeeModel.isEmpty(password))
{
password.requestFocus();
JOptionPane.showMessageDialog(this,"Password Field is Empty","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
if(employeeModel.isEmpty(reTypePassword))
{
reTypePassword.requestFocus();
JOptionPane.showMessageDialog(this,"Re Type Password Field is Empty","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
if(password.getText().trim().equals(reTypePassword.getText().trim())==false)
{
JOptionPane.showMessageDialog(this,"Password & Retype Password are miss matched!!","Notification",JOptionPane.INFORMATION_MESSAGE);
return false;
}
...
public void addAll() throws DAOException
{
employee=new Employee();
employee.setPassword(String.valueOf(password.getText()));
employee.setID(Long.parseLong(ID.getText()));
...
employee.setLastLoginState("Attendence Time,You have Logged In - First Time");
employee.setAttendence(0);
employee.setLoginState(0);
...
JOptionPane.showMessageDialog(this,"Record Added succesfully!!","Notification",JOptionPane.INFORMATION_MESSAGE);
resetAll();
}
